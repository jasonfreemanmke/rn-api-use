...
try {
      ...
      async getRooms()
  {
    ...
    fetch('https://pilot.readylist.com/mobile/get_recent_cleans.php', {
      method: 'POST',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
      ...
      body: JSON.stringify({
        ...
        .then((responseJson) => {
          // this.setState({rooms: responseJson.recent_cleans});
           //alert(responseJson['message']);          
          //alert(responseJson['jwt']);
          //  jwtToken = responseJson.jwt;
          //   msg = responseJson.message;
            rooms = responseJson.recent_cleans
...
<Text style={styles.btnText}>Get Recent Cleans </Text>
